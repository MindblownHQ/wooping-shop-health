					...
					<section class="wsh-statistics">
						<header class="wsh-statistics__header">
							<div class="wsh-statistics__pillars">
								...
								printf( $message, '<a href="' . woop_get_link( trailingslashit( SHOP_HEALTH_DOCUMENTATION_URL ) . 'pillars-of-growth' ) . '" target="_blank">', '</a>' );
								echo '</p>';
								?>
							</div>
							<?php
					...
					<section class="wsh-analytics wsh-widgets__container">
						<section class="wsh-box wsh-analytics__chart" data-location="1">
							<header class="wsh-box__header">
								<?php
								printf( '<h2 class="wsh-box__title">%s</h2>', esc_html__( 'Shop Health', 'wooping-shop-health' ) );
								?>
							</header>
							<?php
							woop_view(
						...
						<section class="wsh-box wsh-analytics__chart" data-location="2">
							<header class="wsh-box__header">
								<?php
								printf( '<h2 class="wsh-box__title">%s</h2>', esc_html__( 'Product Health', 'wooping-shop-health' ) );
								?>
							</header>
							<?php
							woop_view(
						...
						<section class="wsh-box wsh-subscribe" data-location="subscribe">
							<header class="wsh-box__header">
								<?php printf( '<h2 class="wsh-box__title">%s</h2>', esc_html__( 'Subscribe', 'wooping-shop-health' ) ); ?>
								<?php printf( '<p>%s</p>', esc_html__( 'Want to receive periodical tips on how to improve your WooCommerce webshop and stay updated on Wooping.io plugins? Please enter your email and name below and submit. Let\'s stay in touch!', 'wooping-shop-health' ) ); ?>
							</header>
